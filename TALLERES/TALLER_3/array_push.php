...
$misAmigos = ["Jose", "Franco", "Vladimir"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Andres", "Alberto"); // Reemplaza las comillas vacías con los nombres de tus amigos
