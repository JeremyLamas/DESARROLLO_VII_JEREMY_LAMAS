...
$misComidas = ["Papas Fritas", "Tortillas", "Patacones"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Pizza", "Arroz", "Pollo"]; // Reemplaza con las comidas favoritas de tu amigo
