...
$miArray = ["Azul", "Blanco", "Rojo"]; // Reemplaza esto con tu propio array
$miString = "Jeremy"; // Reemplaza esto con tu propio string
$miNumero = 23; // Reemplaza esto con tu propio número
